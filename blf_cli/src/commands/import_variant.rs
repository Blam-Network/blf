...
pub fn import_variant(
    ...
    match (title.as_str(), version.as_str()) {
        ...
        (k_title_haloreach, k_build_string_tu1actual_12065) => {
            v12065_11_08_24_1738_tu1actual::variant_importer::import_variant(&hoppers_config_path, &variant_path);
        }
        ...
        | (k_title_haloreach, "09664.10.04.06.2121.omaha_beta") => {
            v09730_10_04_09_1309_omaha_delta::variant_importer::import_variant(&hoppers_config_path, &variant_path);
        }
        (k_title_haloreach, k_build_string_omaha_alpha_08516) => {
            v08516_10_02_19_1607_omaha_alpha::variant_importer::import_variant(&hoppers_config_path, &variant_path);
        }
        _ => {
