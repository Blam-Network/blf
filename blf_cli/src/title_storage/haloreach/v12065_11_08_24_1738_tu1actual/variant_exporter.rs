...
use blf_lib::blf::versions::haloreach::v12065_11_08_24_1738_tu1actual::{s_blf_chunk_content_header, s_blf_chunk_end_of_file, s_blf_chunk_game_variant, s_blf_chunk_map_variant, s_blf_chunk_start_of_file};
...
pub fn export_variant(source_json_path: &str, desination_path: &str) {
    ...
    if map_variant.is_ok() {
        ...
        blf_file.add_chunk(s_blf_chunk_content_header::create_for_game_variant(&game_variant).unwrap());
