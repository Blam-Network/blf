...
use crate::title_storage::haloreach::v11860_10_07_24_0147_omaha_release::title_storage_config::get_hopper_id_from_hopper_folder_name;
use crate::title_storage::haloreach::v11860_10_07_24_0147_omaha_release::title_storage_output::{hopper_image_height, hopper_image_width, user_nag_message_image_width, user_nag_message_image_height};
...
mod title_storage_output {
    ...
    use blf_lib::blf::versions::haloreach::v11860_10_07_24_0147_omaha_release::{s_blf_chunk_game_set, s_blf_chunk_hopper_configuration_table, s_blf_chunk_hopper_description_table, s_blf_chunk_map_variant, s_blf_chunk_matchmaking_game_variant, s_blf_chunk_network_configuration, s_blf_chunk_online_file_manifest};
...
mod title_storage_config {
    ...
    use blf_lib::blf::versions::haloreach::v11860_10_07_24_0147_omaha_release::{c_hopper_configuration, s_blf_chunk_network_configuration, s_game_hopper_custom_category};
    use blf_lib::OPTION_TO_RESULT;
    ...
    pub fn global_nag_messages_folder_name(tangerine: bool) -> String {
        if tangerine { "global_nag_messages_cea".into() }
        else { "global_nag_messages".into() }
    }
...
impl TitleConverter for v11860_10_07_24_0147_omaha_release {
...
impl v11860_10_07_24_0147_omaha_release {
