...
use blf_lib::blf::versions::ares::v_untracked_ares::{s_blf_chunk_author, s_blf_chunk_end_of_file, s_blf_chunk_message_of_the_day_popup, s_blf_chunk_start_of_file};
...
impl motd_popup {
    pub fn create(mtdp: s_blf_chunk_message_of_the_day_popup) -> Self {
        Self {
            _blf: s_blf_chunk_start_of_file::new("halo3 motd"),
