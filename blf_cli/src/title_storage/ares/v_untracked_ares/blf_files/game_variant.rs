...
use blf_lib::blf::versions::ares::v_untracked_ares::{s_blf_chunk_author, s_blf_chunk_end_of_file, s_blf_chunk_packed_game_variant, s_blf_chunk_start_of_file};
...
impl game_variant {
    pub fn create(game_variant: c_game_variant) -> game_variant {
        game_variant {
            _blf: s_blf_chunk_start_of_file::new("game variant"),
