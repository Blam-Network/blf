...
export class s_condition_was_recently_damaged_by_parameters {
  @AutoMap(() => c_player_reference)
  m_player = new c_player_reference();
  @AutoMap(() => c_player_reference)
  m_attacker = new c_player_reference();
  decode(bitstream: c_bitstream_reader): void {
    this.m_player.decode(bitstream);
    this.m_attacker.decode(bitstream);
  }
  encode(bitstream: c_bitstream_writer): void {
    this.m_player.encode(bitstream);
    this.m_attacker.encode(bitstream);
  }
}

export class s_condition_vehicle_entered_parameters {
  @AutoMap(() => c_object_reference)
  m_object = new c_object_reference();
  decode(bitstream: c_bitstream_reader): void {
    this.m_object.decode(bitstream);
...
export class s_condition_vehicle_exited_parameters {
  @AutoMap(() => c_object_reference)
  m_object = new c_object_reference();
  decode(bitstream: c_bitstream_reader): void {
    this.m_object.decode(bitstream);
...
export class s_condition_vehicle_jacked_parameters {
  @AutoMap(() => c_object_reference)
  m_object = new c_object_reference();
  decode(bitstream: c_bitstream_reader): void {
    this.m_object.decode(bitstream);
...
export class s_condition_is_update_frame_parameters {
  @AutoMap(() => s_variant_variable)
  m_left = new s_variant_variable();
  @AutoMap(() => s_variant_variable)
  m_right = new s_variant_variable();
...
export class s_condition_current_incident_parameters {
  @AutoMap(() => Number)
  m_incident_index = 0;
  decode(bitstream: c_bitstream_reader): void {
    this.m_incident_index = bitstream.read_integer("incident-index", 32);
  }
  encode(bitstream: c_bitstream_writer): void {
    bitstream.write_integer(this.m_incident_index, 32);
  }
}

export class s_condition_object_physics_collided_parameters {
  @AutoMap(() => c_object_reference)
  m_object = new c_object_reference();
  decode(bitstream: c_bitstream_reader): void {
    this.m_object.decode(bitstream);
...
export class s_condition_weapon_is_held_by_hologram_parameters {
  @AutoMap(() => c_object_reference)
  m_object = new c_object_reference();
  decode(bitstream: c_bitstream_reader): void {
    this.m_object.decode(bitstream);
...
export class c_condition {
  ...
  @AutoMap(() => s_condition_was_recently_damaged_by_parameters)
  m_was_recently_damaged_by_parameters?: s_condition_was_recently_damaged_by_parameters;
  ...
  @AutoMap(() => s_condition_vehicle_entered_parameters)
  m_vehicle_entered_parameters?: s_condition_vehicle_entered_parameters;
  @AutoMap(() => s_condition_vehicle_exited_parameters)
  m_vehicle_exited_parameters?: s_condition_vehicle_exited_parameters;
  @AutoMap(() => s_condition_vehicle_jacked_parameters)
  m_vehicle_jacked_parameters?: s_condition_vehicle_jacked_parameters;
  @AutoMap(() => s_condition_is_update_frame_parameters)
  m_is_update_frame_parameters?: s_condition_is_update_frame_parameters;
  @AutoMap(() => s_condition_current_incident_parameters)
  m_current_incident_parameters?: s_condition_current_incident_parameters;
  @AutoMap(() => s_condition_object_physics_collided_parameters)
  m_object_physics_collided_parameters?: s_condition_object_physics_collided_parameters;
  @AutoMap(() => s_condition_weapon_is_held_by_hologram_parameters)
  m_weapon_is_held_by_hologram_parameters?: s_condition_weapon_is_held_by_hologram_parameters;
  ...
  decode(bitstream: c_bitstream_reader): void {
    ...
    this.m_union_group = bitstream.read_integer("union-group", 10);
    ...
    switch (this.m_type) {
      ...
      case e_condition_type.was_recently_damaged_by: {
        const params = new s_condition_was_recently_damaged_by_parameters();
        params.decode(bitstream);
        this.m_was_recently_damaged_by_parameters = params;
        break;
      }
      ...
      case e_condition_type.vehicle_entered: {
        const params = new s_condition_vehicle_entered_parameters();
        params.decode(bitstream);
        this.m_vehicle_entered_parameters = params;
        break;
      }
      case e_condition_type.vehicle_exited: {
        const params = new s_condition_vehicle_exited_parameters();
        params.decode(bitstream);
        this.m_vehicle_exited_parameters = params;
        break;
      }
      case e_condition_type.vehicle_jacked: {
        const params = new s_condition_vehicle_jacked_parameters();
        params.decode(bitstream);
        this.m_vehicle_jacked_parameters = params;
        break;
      }
      case e_condition_type.is_update_frame: {
        const params = new s_condition_is_update_frame_parameters();
        params.decode(bitstream);
        this.m_is_update_frame_parameters = params;
        break;
      }
      case e_condition_type.current_incident: {
        const params = new s_condition_current_incident_parameters();
        params.decode(bitstream);
        this.m_current_incident_parameters = params;
        break;
      }
      case e_condition_type.object_physics_collided: {
        const params = new s_condition_object_physics_collided_parameters();
        params.decode(bitstream);
        this.m_object_physics_collided_parameters = params;
        break;
      }
      case e_condition_type.weapon_is_held_by_hologram: {
        const params = new s_condition_weapon_is_held_by_hologram_parameters();
        params.decode(bitstream);
        this.m_weapon_is_held_by_hologram_parameters = params;
        break;
      }
    }
  }
  ...
  encode(bitstream: c_bitstream_writer): void {
    ...
    bitstream.write_integer(this.m_union_group, 10);
    bitstream.write_integer(this.m_execute_before_action, 11);
    switch (this.m_type) {
      case e_condition_type.if:
      ...
      case e_condition_type.player_died:
        ...
        break;
      case e_condition_type.was_recently_damaged_by:
        this.m_was_recently_damaged_by_parameters!.encode(bitstream);
        break;
      case e_condition_type.team_disposition:
      ...
      case e_condition_type.game_is_forge:
        ...
        break;
      case e_condition_type.vehicle_entered:
        this.m_vehicle_entered_parameters!.encode(bitstream);
        break;
      case e_condition_type.vehicle_exited:
        this.m_vehicle_exited_parameters!.encode(bitstream);
        break;
      case e_condition_type.vehicle_jacked:
        this.m_vehicle_jacked_parameters!.encode(bitstream);
        break;
      case e_condition_type.is_update_frame:
        this.m_is_update_frame_parameters!.encode(bitstream);
        break;
      case e_condition_type.current_incident:
        this.m_current_incident_parameters!.encode(bitstream);
        break;
      case e_condition_type.object_physics_collided:
        this.m_object_physics_collided_parameters!.encode(bitstream);
        break;
      case e_condition_type.weapon_is_held_by_hologram:
        this.m_weapon_is_held_by_hologram_parameters!.encode(bitstream);
        break;
    }
  }
}
