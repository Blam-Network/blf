...
/** Matches `e_action_type` in blf_lib omaha_delta `megalogamengine_actions.rs`. */
export enum e_action_type {
  ...
  team_set_coop_spawning = 57,
  team_set_primary_respawn_object = 58,
  player_set_primary_respawn_object = 59,
  player_get_fireteam_index = 60,
  player_set_fireteam_index = 61,
  object_adjust_shield = 62,
  object_adjust_health = 63,
  object_get_distance = 64,
  object_adjust_maximum_shield = 65,
  object_adjust_maximum_health = 66,
  player_set_requisition_palette = 67,
  player_set_fireteam_tier = 68,
  device_set_power = 69,
  device_get_power = 70,
  device_set_position = 71,
  device_get_position = 72,
  give_weapon = 73,
  adjust_grenades = 74,
  submit_incident = 75,
  submit_incident_with_custom_value = 76,
  set_loadout = 77,
  set_loadout_palette = 78,
  device_set_position_track = 79,
  device_animate_position = 80,
  device_set_position_immediate = 81,
  saved_film_insert_marker = 82,
  respawn_zone_enable = 83,
  player_get_weapon = 84,
  player_get_equipment = 85,
  object_set_never_garbage = 86,
  player_get_target_object = 87,
  create_tunnel = 88,
