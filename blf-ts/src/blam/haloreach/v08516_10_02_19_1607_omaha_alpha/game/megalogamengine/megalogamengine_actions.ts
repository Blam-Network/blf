...
import { c_player_traits } from "../../../v12065_11_08_24_1738_tu1actual/game/game_engine_player_traits";
import {
  e_game_engine_timer_rate,
  e_weapon_pickup_priority,
} from "../../../v12065_11_08_24_1738_tu1actual/game/game_engine_enums";
  ...
  decode(bitstream: c_bitstream_reader): void {
    ...
    switch (this.m_type) {
      ...
      case e_action_type.player_set_fireteam_tier: {
        const player_set_fireteam_tier_parameters = new s_action_player_set_fireteam_tier_parameters();
        player_set_fireteam_tier_parameters.decode(bitstream);
        this.m_player_set_fireteam_tier_parameters = player_set_fireteam_tier_parameters;
        break;
      }
