...
import { c_game_variant } from "../../../blam/haloreach/v08516_10_02_19_1607_omaha_alpha/game/game_variant";
...
/**
 * Reach Private Alpha game variant chunk (`mpvr` 34.1).
 *
 * Payload layout matches later Reach builds: hash + header fields + gametype
 * bitstream, all read through one big-endian bitstream.
 */
@blf.chunk("mpvr", 34.1)
