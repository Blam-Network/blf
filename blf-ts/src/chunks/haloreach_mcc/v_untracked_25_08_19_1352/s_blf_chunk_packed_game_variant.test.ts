...
import { e_game_mode } from "../../../blam/haloreach_mcc/v_untracked_25_08_19_1352/game/c_game_variant";
...
describe("s_blf_chunk_matchmaking_game_variant", () => {
  ...
  it("decodes gametype bytes extracted from mpvr", () => {
    ...
    expect(
      search_for_chunk(readFileSync(reach_12065_oddball_fixture), mpvr, "big")
    ).toBe(true);
