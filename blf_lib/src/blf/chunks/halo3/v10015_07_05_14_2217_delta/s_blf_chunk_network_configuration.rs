...
pub struct s_bandwidth_configuration {
    ...
    #[brw(align_before = 4)]
    pub host_preferences: StaticArray<s_bandwidth_configuration_host_preference_table, 3>,
...
pub struct s_simulation_warping_configuration {
    // "corrective" and "predicted" may be swapped here.
...
pub struct s_simulation_configuration {
    ...
    pub events: StaticArray<s_simulation_event_configuration, 31>,
    pub entities: StaticArray<s_simulation_entity_configuration, 21>,
...
// TODO: double-check, this is probs wrong.
#[derive(Clone, Default, PartialEq, Debug, Serialize, Deserialize, BinRead, BinWrite)]
#[brw(big)]
pub struct s_data_mine_configuration {
    pub ui_upload_time_threshold: i32,
    #[brw(align_after = 4)]
    pub record_uploads_prevent_game_from_starting: Bool, // Not 100% Sure
}
...
pub struct s_griefer_configuration {
    ...
    pub UNUSED_friendly_assist_amount: Float32,
}
...
pub struct s_experience_configuration {
    pub experience_for_rank: StaticArray<i32, 52>,
    pub skill_for_rank: StaticArray<i32, 13>,
}
...
pub struct s_network_configuration {
    ...
    pub alpha_configuration: s_alpha_configuration, // ok
    pub crash_handling_configuration: s_crash_handling_configuration, // ok
}
