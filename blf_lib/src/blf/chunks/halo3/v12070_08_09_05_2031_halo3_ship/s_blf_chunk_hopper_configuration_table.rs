...
impl BinRead for s_blf_chunk_hopper_configuration_table {
    ...
    fn read_options<R: Read + Seek>(reader: &mut R, endian: Endian, args: Self::Args<'_>) -> BinResult<Self> {
        ...
        mhcf.hopper_category_count = bitstream.read_integer(3)?;
        ...
        for i in 0..mhcf.hopper_category_count as usize {
            ...
            category.category_identifier = bitstream.read_integer(16)?;
            category.category_image_index = bitstream.read_integer(6)?;
            category.category_name.set_string(&bitstream.read_string_utf8(16)?)?;
        }

        mhcf.hopper_configuration_count = bitstream.read_integer(6)?;
        ...
        for i in 0..mhcf.hopper_configuration_count as usize {
            ...
            configuration.game_set_hash = s_network_http_request_hash::try_from(bitstream.read_raw_data(0xA0)?)?;
            configuration.hopper_identifier = bitstream.read_integer(16)?;
            configuration.hopper_category = bitstream.read_integer(16)?;
            configuration.hopper_type = bitstream.read_integer(2)?;
            configuration.image_index = bitstream.read_integer(6)?;
            configuration.xlast_index = bitstream.read_integer(5)?;
            configuration.rich_presence_id = bitstream.read_integer(16)?;
            configuration.start_time = bitstream.read_qword(64)?;
            configuration.end_time = bitstream.read_qword(64)?;
            ...
            configuration.minimum_party_size = bitstream.read_integer::<u32>(4)? + 1;
            configuration.maximum_party_size = bitstream.read_integer::<u32>(4)? + 1;
            configuration.hopper_access_bit = bitstream.read_integer::<i8>(4)? - 1;
            configuration.account_type_access = bitstream.read_integer(2)?;
            ...
            configuration.pre_match_voice = bitstream.read_integer(2)?;
            configuration.in_match_voice = bitstream.read_integer(2)?;
            configuration.post_match_voice = bitstream.read_integer(2)?;
            ...
            configuration.stats_write = bitstream.read_integer(2)?;
            configuration.language_filter = bitstream.read_integer(2)?;
            configuration.country_code_filter = bitstream.read_integer(2)?;
            configuration.gamerzone_filter = bitstream.read_integer(2)?;
            configuration.quitter_filter_percentage = bitstream.read_integer(7)?;
            configuration.quitter_filter_maximum_party_size = bitstream.read_integer(4)?;
            configuration.rematch_countdown_timer = bitstream.read_integer(10)?;
            configuration.rematch_group_formation = bitstream.read_integer(2)?;
            configuration.repeated_opponents_to_consider_for_penalty = bitstream.read_integer(7)?;
            configuration.repeated_opponents_experience_threshold = bitstream.read_integer(4)?;
            configuration.repeated_opponents_skill_throttle_start = bitstream.read_integer(4)?;
            configuration.repeated_opponents_skill_throttle_stop = bitstream.read_integer(4)?;
            configuration.maximum_total_matchmaking_seconds = bitstream.read_integer(10)?;
            configuration.gather_start_game_early_seconds = bitstream.read_integer(10)?;
            configuration.gather_give_up_seconds = bitstream.read_integer(10)?;

            for i in 0..configuration.chance_of_gathering.len() {
                configuration.chance_of_gathering[i] = bitstream.read_integer(7)?;
            }

            configuration.experience_points_per_win = bitstream.read_integer(2)?;
            configuration.experience_penalty_per_drop = bitstream.read_integer(2)?;
            ...
            for i in 0..configuration.maximum_skill_level_match_delta.get().iter().len() {
                configuration.maximum_skill_level_match_delta.get_mut()[i] = bitstream.read_integer(6)?;
            }
            ...
            configuration.trueskill_draw_probability = bitstream.read_integer(7)?;
            configuration.trueskill_hillclimb_w0 = bitstream.read_integer(7)?;
            configuration.trueskill_hillclimb_w50 = bitstream.read_integer(7)?;
            configuration.trueskill_hillclimb_w100 = bitstream.read_integer(7)?;
            configuration.trueskill_hillclimb_w150 = bitstream.read_integer(7)?;
            configuration.skill_update_weight_s0 = bitstream.read_integer(7)?;
            configuration.skill_update_weight_s10 = bitstream.read_integer(7)?;
            configuration.skill_update_weight_s20 = bitstream.read_integer(7)?;
            configuration.skill_update_weight_s30 = bitstream.read_integer(7)?;
            configuration.skill_update_weight_s40 = bitstream.read_integer(7)?;
            configuration.skill_update_weight_s50 = bitstream.read_integer(7)?;
            configuration.quality_update_weight_q0 = bitstream.read_integer(7)?;
            configuration.quality_update_weight_q25 = bitstream.read_integer(7)?;
            configuration.quality_update_weight_q50 = bitstream.read_integer(7)?;
            configuration.quality_update_weight_q75 = bitstream.read_integer(7)?;
            configuration.quality_update_weight_q100 = bitstream.read_integer(7)?;

            if configuration.hopper_type <= 1 {
                configuration.minimum_player_count = bitstream.read_integer::<u8>(4)? + 1;
                configuration.maximum_player_count = bitstream.read_integer::<u8>(4)? + 1;
            }
            else if configuration.hopper_type >= 2 {
                configuration.team_count = bitstream.read_integer::<u8>(3)? + 1;
                configuration.minimum_team_size = bitstream.read_integer::<u8>(3)? + 1;
                configuration.maximum_team_size = bitstream.read_integer::<u8>(3)? + 1;
                ...
                if configuration.hopper_type == 2 {
                    ...
                    configuration.maximum_team_imbalance = bitstream.read_integer(3)?;
                    configuration.big_squad_size_threshold = bitstream.read_integer::<u8>(4)? + 1;
                    configuration.maximum_big_squad_imbalance = bitstream.read_integer(3)?;
