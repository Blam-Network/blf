...
impl BinRead for s_blf_chunk_hopper_configuration_table {
    ...
    fn read_options<R: Read + Seek>(reader: &mut R, endian: Endian, args: Self::Args<'_>) -> BinResult<Self> {
        ...
        for i in 0..mhcf.hopper_category_count as usize {
            ...
            category.category_image_index = bitstream.read_unnamed_integer(6)?;
            category.category_name.set_string(&bitstream.read_string_utf8(16)?)?;
        }

        mhcf.hopper_configuration_count = bitstream.read_unnamed_integer(6)?;
        ...
        for i in 0..mhcf.hopper_configuration_count as usize {
            ...
            configuration.rich_presence_id = bitstream.read_unnamed_integer(16)?;
            ...
            configuration.minimum_base_xp = bitstream.read_unnamed_integer(17)?;
            configuration.maximum_base_xp = bitstream.read_unnamed_integer(17)?;
            configuration.minimum_games_played = bitstream.read_unnamed_integer(17)?;
            configuration.maximum_games_played = bitstream.read_unnamed_integer(17)?;
            ...
            configuration.require_all_party_members_meet_games_played_requirements = bitstream.read_unnamed_bool()?;
            ...
            configuration.hide_hopper_from_games_played_restricted_players = bitstream.read_unnamed_bool()?;
            ...
            configuration.hide_hopper_due_to_time_restriction = bitstream.read_unnamed_bool()?;
            configuration.pre_match_voice = bitstream.read_unnamed_integer(2)?;
            configuration.in_match_voice = bitstream.read_unnamed_integer(2)?;
            configuration.post_match_voice = bitstream.read_unnamed_integer(2)?;
            configuration.restrict_open_channel = bitstream.read_unnamed_bool()?;
            ...
            configuration.require_hosts_on_multiple_teams = bitstream.read_unnamed_bool()?;
            ...
            configuration.repeated_opponents_to_consider_for_penalty = bitstream.read_unnamed_integer(7)?;
            configuration.repeated_opponents_experience_threshold = bitstream.read_unnamed_integer(4)?;
            configuration.repeated_opponents_skill_throttle_start = bitstream.read_unnamed_integer(4)?;
            configuration.repeated_opponents_skill_throttle_stop = bitstream.read_unnamed_integer(4)?;
            ...
            configuration.trueskill_adjust_tau_with_update_weight = bitstream.read_unnamed_bool()?;
            configuration.trueskill_draw_probability = bitstream.read_unnamed_integer(7)?;
            configuration.trueskill_hillclimb_w0 = bitstream.read_unnamed_integer(7)?;
            configuration.trueskill_hillclimb_w50 = bitstream.read_unnamed_integer(7)?;
            configuration.trueskill_hillclimb_w100 = bitstream.read_unnamed_integer(7)?;
            configuration.trueskill_hillclimb_w150 = bitstream.read_unnamed_integer(7)?;
            configuration.skill_update_weight_s0 = bitstream.read_unnamed_integer(7)?;
            configuration.skill_update_weight_s10 = bitstream.read_unnamed_integer(7)?;
            configuration.skill_update_weight_s20 = bitstream.read_unnamed_integer(7)?;
            configuration.skill_update_weight_s30 = bitstream.read_unnamed_integer(7)?;
            configuration.skill_update_weight_s40 = bitstream.read_unnamed_integer(7)?;
            configuration.skill_update_weight_s50 = bitstream.read_unnamed_integer(7)?;
            configuration.quality_update_weight_q0 = bitstream.read_unnamed_integer(7)?;
            configuration.quality_update_weight_q25 = bitstream.read_unnamed_integer(7)?;
            configuration.quality_update_weight_q50 = bitstream.read_unnamed_integer(7)?;
            configuration.quality_update_weight_q75 = bitstream.read_unnamed_integer(7)?;
            configuration.quality_update_weight_q100 = bitstream.read_unnamed_integer(7)?;
            ...
            if configuration.hopper_type <= 1 {
                ...
                if configuration.hopper_type == 2 {
                    ...
                    configuration.allow_parties_to_split = bitstream.read_unnamed_bool()?;
                }
...
impl BinWrite for s_blf_chunk_hopper_configuration_table {
    ...
    fn write_options<W: Write + Seek>(&self, writer: &mut W, endian: Endian, args: Self::Args<'_>) -> BinResult<()> {
        ...
        for i in 0..self.hopper_configuration_count as usize {
            ...
            bitstream.write_raw_data(&configuration.game_set_hash.data.get(), 0xA0)?;
