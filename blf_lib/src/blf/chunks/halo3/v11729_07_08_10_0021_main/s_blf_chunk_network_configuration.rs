...
pub struct s_observer_configuration {
    ...
    // TODO: Not 100% sure which bools are included here. Should double check.
    // pub mark_throttled_stream_with_one_failure: u8,
    // pub check_single_stream_overprobe: u8,
    // pub use_deviation_only_for_related_rtt_timeout: u8,
    // pub fast_probe_failed_streams: u8,
...
pub struct s_network_configuration {
    ...
    pub chicken_switches: s_chicken_switches, // unconfirmed
}
