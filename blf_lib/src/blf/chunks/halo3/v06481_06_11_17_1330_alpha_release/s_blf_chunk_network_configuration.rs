...
pub struct s_bandwidth_configuration {
    ...
    pub unknown1: u32,
    pub unknown3: StaticArray<i32, 17>,
    pub unknown2: u32,
    pub unknown4: StaticArray<i32, 17>,
}
...
pub struct s_simulation_configuration {
    ...
    pub events: StaticArray<s_simulation_event_configuration, 30>,
    pub entities: StaticArray<s_simulation_entity_configuration, 20>,
