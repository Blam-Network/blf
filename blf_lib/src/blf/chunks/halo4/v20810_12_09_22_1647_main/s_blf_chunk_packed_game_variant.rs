...
/// Halo 4 matchmaking game variant chunk (`gvar` 54.1).
///
...
/// Alias matching historical Reach naming in some call sites.
pub type s_blf_chunk_matchmaking_game_variant = s_blf_chunk_packed_game_variant;
