...
{
    pub data: StaticArray<u8, 0x1A70>
...
#[derive(Clone, Default, PartialEq, Debug, Serialize, Deserialize, BinRead, BinWrite)]
#[brw(big)]
pub struct s_halt_configuration {
    pub unknown1: i32,
    pub unknown2: i32,
    pub unknown3: i32,
    pub unknown4: i32,
    pub unknown5: i32,
    pub unknown6: Float32,
}

#[derive(Clone, Default, PartialEq, Debug, Serialize, Deserialize, BinRead, BinWrite)]
#[brw(big)]
pub struct s_simulation_configuration {
    pub unknown64C: Float32,
    pub unknown650: Float32,
    pub unknown654: Float32,
    pub unknown658: Float32, // think it's zoom related
    pub unknown65C: Float32,
    pub unknown660: Float32,
    pub unknown664: Float32,
    pub unknown668: Float32,
    pub unknown66C: Float32,
    pub unknown670: Float32,
    pub unknown674: Float32,
    pub unknown678: Float32,
    ...
    pub unknown6: Float32,
    pub unknown7: Float32,
    pub unknown8: Float32,
    pub unknown9: Float32,
...
pub struct s_logic_matchmaking_desirability {
    ...
    pub average_mu_range_for_desirability_bonus: Float32,
...
pub struct s_logic_matchmaking_seeker_configuration {
    ...
    pub search_stage_strict_skill_initial_mu_range: Float32,
    pub search_stage_strict_skill_final_mu_range: Float32,
    ...
    pub search_stage_any_final_mu_range: Float32,
...
pub struct s_session_interface_configuration {
    // h3 has some fields here, but we don't know which were removed yet.
    pub unknown1: i32,
    pub unknown2: i32,
    pub unknown3: i32,
...
#[derive(Clone, Default, PartialEq, Debug, Serialize, Deserialize, BinRead, BinWrite)]
#[brw(big)]
pub struct s_bandwidth_unknown_struct_1 {
    pub unknown1: i32,
    pub unknown2: i32,
    pub unknown3: Float32,
...
pub struct s_bandwidth_configuration {
    ...
    pub loaded_voice_stream_cost_bps: i32,
    pub unknown3e4: i32,
    pub unknown3e8: Float32,
    pub unknown3ec: Float32,
    pub unknown3f0: Float32,
    pub unknown3f4: Float32,
    pub unknown3f8: Float32,
    pub unknown3fc: Float32,
    pub unknown400: i32,
    pub unknown404: i32,
    pub unknown408_latency_estimate: f32,
    pub unknown40c_latency_variance_estimate: f32,
    pub packet_loss_pct: f32,
    pub unknown2: StaticArray<s_bandwidth_unknown_struct_1, 5>,
}
...
pub struct s_observer_configuration {
    // s_channel_manager_configuration
    ...
    pub safety_window_threshold: Float32,
    ...
    // pub stream_loss_throttle_fraction: Float32,
    // pub stream_throttle_rtt_multiplier: i32,
    // pub stream_throttle_reduce_multiplier: Float32,
    ...
    // pub stream_bandwidth_step_max_fraction: Float32,
    // #[serde(with = "SerHex::<StrictCapPfx>")]
    // pub stream_bandwidth_backoff_bps: u32,
    // pub stream_bandwidth_backoff_max_fraction: Float32,
    ...
    // pub stream_throughput_satiated_stream_fraction: Float32,
    ...
    // pub stream_growth_maximum_fraction: Float32,
    // pub stream_growth_desire_maximum: Float32,
    // pub stream_growth_desire_delay_multiplier: i32,
    // pub stream_growth_desire_penalty_bandwidth_multiplier: Float32,
    ...
    pub stable_probe_settle_bandwidth_multiplier: Float32,
    ...
    pub initial_probe_settle_bandwidth_multiplier: Float32,
    ...
    pub fast_probe_settle_bandwidth_multiplier: Float32,
    ...
    pub slow_probe_settle_bandwidth_multiplier: Float32,
...
pub struct s_connection_configuration {
    ...
    // pub bandwidth_warning_latency_multiplier: Float32,
...
pub struct s_data_mine_configuration {
    ...
    pub sp_player_update_interval: i32,
    pub mp_player_update_interval: i32,
}
...
pub struct s_replication_control_view {
    ...
    pub max_priority: Float32,
    pub medium_priority_base: Float32,
    pub medium_priority_relevance_scale: Float32,
    pub min_priority_base: Float32,
    pub min_priority_relevance_scale: Float32,
}
...
pub struct s_chicken_switches {
    pub unknown1AF4: Bool,
    pub unknown1AF5_session: Bool,
    pub unknown1AF6: Bool,
    pub unknown1AF7: Bool,
    pub unknown1AF8: i32,
...
#[derive(Clone, Default, PartialEq, Debug, Serialize, Deserialize, BinRead, BinWrite)]
#[brw(big)]
pub struct s_active_roster_configuration {
    pub unknown1b10: i32,
    pub unknown1b14: i32,
    pub unknown1b18: i32,
    pub unknown1b1c: i32,
    ...
    pub unknown1b28: i32,
    pub unknown1b2c: i32,
    pub unknown1b30_qos: i32,
    pub unknown1b34_qos_max_active: i32,
    pub unknown1b38: i32,
    pub unknown1b3c: i32,
    pub unknown1b40: i32,
    pub unknown1b44_partial_qos_failure_limit: i32,
    pub unknown1b48: i32,
    pub unknown1b4c: i32,
    pub unknown1b50: i32,
    pub unknown1b54: i32,
    #[brw(pad_after = 3)]
    pub unknown1b58_presence_flag: Bool,
    pub unknown1b5c: i32,
    pub unknown1b60: i32,
    pub unknown1b64: i32,
    pub unknown1b68_time: i32,
    pub unknown1b6c: i32,
