...
use blf_lib::blf::versions::haloreach::v12065_11_08_24_1738_tu1actual::s_hopper_voting_configuration;
...
pub struct s_hopper_query_configuration {
    // this struct has 12 fewer bytes than in v25, not sure which fields are missing though.
    pub unknown00: u32,
    #[brw(pad_after = 3)]
    pub unknown04: Bool,
    pub unknown08: u32,
    ...
    #[brw(pad_after = 3)]
    pub unknown34: Bool,
    pub latency_desirability_configurations: StaticArray<blf_lib::blf::versions::haloreach::v11860_10_07_24_0147_omaha_release::s_hopper_query_latency_desirability_configuration, 2>,
    pub unknown50: StaticArray<Float32, 14>,
}

#[derive(Clone, Default, PartialEq, Debug, Serialize, Deserialize, BinRead, BinWrite, TestSize)]
#[Size(0x3F8)] // see multiplayer_game_hoppers_get_hopper_configuration
pub struct c_hopper_configuration {
    // v24 has 12 bytes less data in here than v25, but im not sure where exactly.
