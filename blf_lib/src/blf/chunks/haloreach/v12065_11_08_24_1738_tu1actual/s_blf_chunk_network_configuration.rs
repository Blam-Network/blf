...
#[derive(Clone, Default, PartialEq, Debug, Serialize, Deserialize, BinRead, BinWrite)]
#[brw(big)]
pub struct s_simulation_unknown_struct_1 {
    pub unknown1: i32,
    pub unknown2: i32,
    pub unknown3: i32,
    pub unknown4: i32,
    pub unknown5: Float32,
    pub unknown6: i32,
}
...
pub struct s_simulation_configuration {
    ...
    pub unknown_data: StaticArray<i32, 28>,
    pub world: s_simulation_world_configuration,
    pub unknown1: i32,
    pub unknown2: StaticArray<s_simulation_unknown_struct_1, 8>,
