...
pub const k_maximum_hopper_categories: usize = 16;
pub const k_maximum_hopper_configurations: usize = 32; // TODO: Check, this seems low.
...
impl BinRead for s_blf_chunk_hopper_configuration_table {
    ...
    fn read_options<R: Read + Seek>(reader: &mut R, endian: Endian, args: Self::Args<'_>) -> BinResult<Self> {
        ...
        for i in 0..k_maximum_hopper_categories {
