...
use blf_lib::blam::halo4::v20810_12_09_22_1647_main::math::real_math::{dequantize_unit_vector3d, quantize_real, quantize_real_fast};
...
use crate::blam::halo4::v20810_12_09_22_1647_main::math::real_math::quantize_unit_vector3d_fast;
...
impl c_bitstream_writer_extensions for c_bitstream_writer {
    fn bitstream_writer(&mut self) -> &mut c_bitstream_writer {
        self
    }
}
