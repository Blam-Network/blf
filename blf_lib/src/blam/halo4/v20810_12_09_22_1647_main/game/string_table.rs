...
pub const k_language_count: usize = 17;
...
>
{
    pub fn decode(&mut self, bitstream: &mut c_bitstream_reader) -> BLFLibResult {
        ...
        // i32: H4 script strings allow offsets up to 40960 (past i16::MAX); -1 = missing.
        let mut offsets = vec![vec![0i32; string_count]; k_language_count];
