...
use crate::blam::haloreach::v09730_10_04_09_1309_omaha_delta::game::game_engine_player_traits::c_player_traits;
...
impl c_game_engine_survival_variant {
    pub fn encode(&self, bitstream: &mut c_bitstream_writer) -> BLFLibResult {
        ...
        for skull_flags in self.m_skull_flags.get() {
            bitstream.write_integer(*skull_flags, 14)?;
        }
    ...
    pub fn decode(&mut self, bitstream: &mut c_bitstream_reader) -> BLFLibResult {
        ...
        for i in 0..9 {
            self.m_skull_flags[i] = bitstream.read_integer("skull-flags", 14)?;
        }
...
impl s_survival_wave_properties {
    pub fn encode(&self, bitstream: &mut c_bitstream_writer) -> BLFLibResult {
        ...
        bitstream.write_integer(self.m_skull_flags, 14)?;
    ...
    pub fn decode(&mut self, bitstream: &mut c_bitstream_reader) -> BLFLibResult {
        ...
        self.m_skull_flags = bitstream.read_integer("skull_flags", 14)?;
