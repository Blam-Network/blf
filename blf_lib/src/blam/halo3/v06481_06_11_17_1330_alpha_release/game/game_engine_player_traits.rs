...
pub struct c_player_trait_weapons {
    ...
    pub m_initial_grenade_type_absolute_index: i8,
...
impl c_player_traits {
    pub fn encode(&self, bitstream: &mut c_bitstream_writer) -> BLFLibResult {
        ...
        bitstream.write_signed_integer(self.m_weapon_traits.m_initial_grenade_type_absolute_index as i32, 8)?;
        bitstream.write_integer(self.m_weapon_traits.m_initial_grenade_count_setting as u32, 3)?;
    ...
    pub fn decode(&mut self, bitstream: &mut c_bitstream_reader) -> BLFLibResult {
        ...
        self.m_weapon_traits.m_initial_grenade_type_absolute_index = bitstream.read_unnamed_signed_integer(8)?;
        self.m_weapon_traits.m_initial_grenade_count_setting = bitstream.read_unnamed_integer(3)?;
