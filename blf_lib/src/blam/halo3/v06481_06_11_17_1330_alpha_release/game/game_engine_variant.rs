...
use blf_lib::blam::halo3::v06481_06_11_17_1330_alpha_release::game::game_engine_default::c_game_engine_base_variant;
use blf_lib::blam::halo3::v06481_06_11_17_1330_alpha_release::game::game_engine_slayer::c_game_engine_slayer_variant;
use blf_lib::blam::halo3::v06481_06_11_17_1330_alpha_release::game::game_engine_assault::c_game_engine_assault_variant;
use blf_lib::blam::halo3::v06481_06_11_17_1330_alpha_release::game::game_engine_ctf::c_game_engine_ctf_variant;
use blf_lib::blam::halo3::v06481_06_11_17_1330_alpha_release::game::game_engine_infection::c_game_engine_infection_variant;
use blf_lib::blam::halo3::v06481_06_11_17_1330_alpha_release::game::game_engine_juggernaut::c_game_engine_juggernaut_variant;
use blf_lib::blam::halo3::v06481_06_11_17_1330_alpha_release::game::game_engine_king::c_game_engine_king_variant;
use blf_lib::blam::halo3::v06481_06_11_17_1330_alpha_release::game::game_engine_oddball::c_game_engine_oddball_variant;
use blf_lib::blam::halo3::v06481_06_11_17_1330_alpha_release::game::game_engine_sandbox::c_game_engine_sandbox_variant;
use blf_lib::blam::halo3::v06481_06_11_17_1330_alpha_release::game::game_engine_territories::c_game_engine_territories_variant;
use blf_lib::blam::halo3::v06481_06_11_17_1330_alpha_release::game::game_engine_vip::c_game_engine_vip_variant;
    ...
    fn write_options<W: Write + Seek>(&self, writer: &mut W, endian: Endian, args: Self::Args<'_>) -> BinResult<()> {
        match endian {
            Endian::Big => {
                ...
                writer.write_be(&self.m_description_index)?;
    ...
    fn read_options<R: Read + Seek>(reader: &mut R, endian: Endian, args: Self::Args<'_>) -> BinResult<Self> {
        ...
        let read_variant = match endian {
            Endian::Big => {
                ...
                let description_index: u8 = reader.read_be()?;
                ...
                let mut game_variant = c_game_variant {
                    ...
                    m_description_index: description_index,
...
impl c_game_variant {
    pub fn encode(&self, bitstream: &mut c_bitstream_writer) -> BLFLibResult {
        ...
        bitstream.write_integer(self.m_description_index, 8)?;
    ...
    pub fn decode(&mut self, bitstream: &mut c_bitstream_reader) -> BLFLibResult {
        ...
        self.m_description_index = bitstream.read_integer("description-index", 8)?;
