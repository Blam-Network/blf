...
impl c_player_traits {
    ...
    pub fn decode(&mut self, bitstream: &mut c_bitstream_reader) -> BLFLibResult {
        self.m_shield_vitality_traits.m_damage_resistance_percentage_setting = bitstream.read_unnamed_enum_raw(4)?;
        self.m_shield_vitality_traits.m_shield_recharge_rate_percentage_setting = bitstream.read_unnamed_enum_raw(4)?;
        self.m_shield_vitality_traits.m_vampirism_percentage_setting = bitstream.read_unnamed_enum_raw(3)?;
        self.m_shield_vitality_traits.m_headshot_immunity_setting = bitstream.read_unnamed_enum_raw(2)?;
        self.m_shield_vitality_traits.m_shield_multiplier_setting = bitstream.read_unnamed_enum_raw(3)?;
